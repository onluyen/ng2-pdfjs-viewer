...
const PDFViewerApplication = {
  ...
  async _initializeViewerComponents() {
    ...
    if (appConfig.toolbar) {
      ...
      const secondaryCloseFile = document.getElementById("secondaryCloseFile");
      if (secondaryCloseFile) {
        secondaryCloseFile.addEventListener("click", function () {
          window.parent.postMessage({event: "closefile"}, "*");
        });
      }
    }
  ...
  bindEvents() {
    ...
    eventBus._on("closefile", onOpenFile.bind(this), opts);
  },
  bindWindowEvents() {
...
window.applyParameterOverride = function(config) {
  ...
  if (window.getUrlParameterByName('find') === "false") {
    config.findBar.viewFind.classList.add('hidden');
  }

  if (window.getUrlParameterByName('editor') === "false") {
    config.toolbar.editorFreeTextButton.classList.add('hidden');
    config.toolbar.editorFreeTextParamsToolbar.classList.add('hidden');
    config.toolbar.editorHighlightButton.classList.add('hidden');
    config.toolbar.editorHighlightParamsToolbar.classList.add('hidden');
    config.toolbar.editorHighlightColorPicker.classList.add('hidden');
    config.toolbar.editorInkButton.classList.add('hidden');
    config.toolbar.editorInkParamsToolbar.classList.add('hidden');
    config.toolbar.editorStampButton.classList.add('hidden');
    config.toolbar.editorStampParamsToolbar.classList.add('hidden');
  }
